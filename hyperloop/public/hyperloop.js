...
Opal.modules["hyper-operation/version"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return Opal.cdecl($scope, 'VERSION', "0.5.11")
    })($scope.base, null)
  })($scope.base)
};
...
if (response == null) response = nil;
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_10, $a, TMP_13, TMP_18, TMP_19;
...
if (data == null) data = nil;
      ...
      Opal.defs(self, '$initialize_client_drivers_on_boot', TMP_18 = function $$initialize_client_drivers_on_boot() {
        var $a, $b, TMP_14, $c, TMP_15, $d, $e, $f, TMP_16, $g, TMP_17, self = this, h = nil, pusher_api = nil;
        ...
        if ((($a = self.initialized) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if ((($a = $scope.get('Hyperloop').$action_cable_consumer()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            ($a = ($b = $scope.get('HTTP')).$get, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this, $c;
            ...
            if ((($c = $scope.get('Hyperloop').$action_cable_consumer().connection.disconnected) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
                ...
                return nil
              }}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $a).call($b, "" + (window.HyperloopEnginePath) + "/server_up")};
          return nil;};
        ...
        if ((($a = self['$on_opal_client?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if (self.$opts()['$[]']("transport")['$==']("pusher")) {
            self.$opts()['$[]=']("dispatch", ($a = ($c = self).$lambda, $a.$$p = (TMP_15 = function(data){var self = TMP_15.$$s || this;
if (data == null) data = nil;
            return self.$sync_dispatch($scope.get('JSON').$parse(JSON.stringify(data)))}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15), $a).call($c));
            ...
            ($e = ($f = self.$opts()['$[]']("auto_connect")).$each, $e.$$p = (TMP_16 = function(channel){var self = TMP_16.$$s || this, $g;
if (channel == null) channel = nil;
            return ($g = $scope.get('IncomingBroadcast')).$add_connection.apply($g, Opal.to_a(channel))}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16), $e).call($f);
            return ($e = ($g = self).$every, $e.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this;

            return self.$get_queued_data("read", nil, $hash2(["headers"], {"headers": $hash2(["X-HYPERLOOP-SILENT-REQUEST"], {"X-HYPERLOOP-SILENT-REQUEST": true})}))}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $e).call($g, self.$opts()['$[]']("seconds_between_poll"));
            } else {
            return nil
          }
          } else {
      ...
      return (Opal.defs(self, '$polling_path', TMP_19 = function $$polling_path(to, id) {
        var self = this, s = nil;
        ...
        if (id !== false && id !== nil && id != null) {
          s = "" + (s) + "/" + (id)};
        return s;
      }, TMP_19.$$arity = -2), nil) && 'polling_path';
    })($scope.base, null);
  })($scope.base)
};
